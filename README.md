...
The guidelines for writing commit messages were adapted from Michael Jones's [on-commit-messages](https://github.com/michaeljones/on-commit-messages) repository. 
